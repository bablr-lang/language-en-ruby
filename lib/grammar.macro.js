...
import { mixin as logicMixin } from './mixins/call.js';
...
export const atrivialGrammar = class RubyGrammar extends literalMixin(
  functionMixin(statementMixin(logicMixin(Object))),
) {
  *[Symbol.for('@bablr/fragment')]({ props: { rootMatcher } }) {
  ...
  @Node
  *Program() {
    yield eat(m`statements[]: <_Statements />`);
  }
